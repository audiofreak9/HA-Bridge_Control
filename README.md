...
Code written in PHP that allows control of all @bwssytems <a href="https://github.com/bwssytems/ha-bridge#ha-bridge-usage-and-configuration">ha-bridge</a> devices by with a phone, tablet or desktop.  It uses twitter bootstrap for mobile compatibility and fluidity.
