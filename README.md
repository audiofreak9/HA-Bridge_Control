...
5. Set up and configuration:
  ...
  * The DEFAULT ha-bridge IP is `$_SERVER['SERVER_NAME'];`.  This will auto-detect, otherwise set according to your ha-bridge installation IP, example: `$SN = "192.168.1.2;`
